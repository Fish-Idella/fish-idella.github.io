function createQRImage(P, Q, X) {
	function W(a) {
		...
		1 <= e && 127 >= e ? b += a.charAt(c) : 2047 < e ? (b += String.fromCharCode(224 | e >> 12 & 15), b += String.fromCharCode(128 | e >> 6 & 63), b += String.fromCharCode(128 | e >> 0 & 63)) : (b += String.fromCharCode(192 | e >> 6 & 31), b += String.fromCharCode(128 | e >> 0 & 63));
		return b
	}
	var l = {
	...
	this.drawImage = function(f) {
		...
		if (D.width = D.height = a.width, b.fillStyle = a.bgColor, b.fillRect(0, 0, a.width, a.width), null != a.background) {
			var c = a.background.width,
			h = a.background.height;
			if (0 < c) for (var e = 0; e < a.width; e += c) for (var g = 0; g < a.width; g += h) b.drawImage(a.background, e, g, c, h)
		}
		c = "";
		h = E.length;
		...
		if (0 != a.pinType) {
			...
			switch (b.save(), b.beginPath(), b.fillStyle = a.ptColor || a.fgColor, b.fillRect(a.margin - d + 1, a.margin - d + 1, 9 * d - 2, 9 * d - 2), b.fillStyle = a.inptColor || a.fgColor, a.pinType) {
			case 7:
		...
		b.save();
		for (e = 0; e < h; e++) for (g = 0; g < h; g++) m(e, g) ? 0 != a.pinType && H(e, g, h) || (c = F[e][g] ? a.paintColor: a.ptColor || a.inptColor && H(e, g, h) ? S(e, g, h) : a.fgColor, null == a.gcColor || (a.ptColor || a.inptColor) && H(e, g, h) || (c = K), b.fillStyle = c, b.strokeStyle = c, p = g * d + a.margin, n = e * d + a.margin + d / 2, b.beginPath(), b.moveTo(p, n), a.round ? a.isWater ? (m(e, g - 1) || m(e - 1, g) || m(e - 1, g - 1) ? I(b, g, e, 0) : A(b, g, e, 0), m(e - 1, g) || m(e, g + 1) || m(e - 1, g + 1) ? I(b, g, e, 1) : A(b, g, e, 1), m(e + 1, g) || m(e, g + 1) || m(e + 1, g + 1) ? I(b, g, e, 2) : A(b, g, e, 2), m(e + 1, g) || m(e, g - 1) || m(e + 1, g - 1) ? I(b, g, e, 3) : A(b, g, e, 3)) : (A(b, g, e, 0), A(b, g, e, 1), A(b, g, e, 2), A(b, g, e, 3)) : b.rect(Math.round(g * d + a.margin) + .5, Math.round(e * d + a.margin) + .5, Math.round(d), Math.round(d)), b.closePath(), null != a.foreground ? T(b) : (b.fill(), b.stroke())) : a.isWater && (c = F[e][g] ? a.paintColor: a.ptColor || a.inptColor ? S(e, g, h) : a.fgColor, H(e, g, h) || (m(e - 1, g) && m(e, g - 1) && J(b, g, e, 0, c), m(e + 1, g) && m(e, g - 1) && J(b, g, e, 3, c), m(e + 1, g) && m(e, g + 1) && J(b, g, e, 2, c), m(e - 1, g) && m(e, g + 1) && J(b, g, e, 1, c)));
		b.restore();
		for (e = 0; e < a.rotate; e++) {
			...
			n = t.data.length;
			t = t.width;
			for (i = 0; i < n; i += 4) v = i % (4 * t) * t + 4 * (t - Math.floor(i / t / 4) - 1),
			p[v] = g[i],
			p[v + 1] = g[i + 1],
			p[v + 2] = g[i + 2],
			p[v + 3] = g[i + 3];
		...
		if (null != a.logoimg && "L" != a.level) switch (c = a.width / l.width, a.logoType) {
		case "icon":
			h = a.logoimg;
			e = 3 * c;
			g = k.left * c;
		...
		case "stroke":
			...
			b.shadowBlur = 0;
			b.shadowColor = "#FFF";
			for (t = 0; t < 2 * e + 1; t++) for (v = 0; v < 2 * e + 1; v++) b.save(),
		...
		if (a.content) {
			...
			h = a.width / l.width;
			switch (b.globalCompositeOperation = "source-over", b.save(), b.textBaseline = "middle", b.textAlign = "center", b.font = "bold " + a.fontSize * h + "px KaiTi_GB2312", a.fontEffect) {
			case "in":
				b.lineWidth = 8 * h;
				b.fillStyle = c;
			...
			case "stretch":
				...
				b.strokeStyle = "#fff";
				for (c = 0; c < r; c++) b.globalAlpha = (c + 1) / r,
	...
	this.changePtImage = function(f) {
		a.pinType = f;
		0 != a.pinType ? V(["images/2013/diy/small/pin-" + a.pinType + ".png", "images/2013/diy/big/pin-" + a.pinType + ".png"],
		function(a) {
			R = a;
			u.drawImage()
		}) : u.drawImage()
	...
	this.resetLogoimg = function(f) {
		a.logoimg = l.logoimg;
		a.logoimg || a.content || (a.level = l.level, k = {},
		f());
		z()
	};
	...
	this.getBase64 = function(f) {
		...
		if (B != a.width) {
			...
			L = 0;
			u.drawImage()
		} else b = D.toDataURL().substring(22);
		f(b)
	};
	var G = function() {},
	V = function(a, b) {
		function c(e) {
			if (! (e < a.length)) return void b(d);
			var g = new Image;
			g.src = a[e];
			d.push(g);
			g.onload = function() {
	...
	O = function(f, b) {
		...
		if (c.type && !/image\/\w+/.test(c.type)) return alert("\u8bf7\u786e\u4fdd\u6587\u4ef6\u4e3a\u56fe\u50cf\u7c7b\u578b"),
		!1;
			...
			function(c) {
				...
				if ("logoimg" == b) {
					...
					if (null != a.logoimg && "L" != a.level) {
						...
						f = (0 < f && (Math.max(f, e) < q ? (c = f, d = e) : f > e ? (c = q, d = Math.floor(q / f * e)) : (d = q, c = Math.floor(q / e * f)), h = Math.floor(l.width / 2 - c / 2), m = Math.floor(l.width / 2 - d / 2)), {
							left: h,
							top: m,
							width: c,
							height: d
	...
	T = function(f) {
		...
		if (0 < b) for (var d = 0; d < a.width; d += b) for (var e = 0; e < a.width; e += c) f.drawImage(a.foreground, d, e, b, c);
		f.restore()
	},
	I = function(f, b, c, h) {
		var e = 0,
	...
	J = function(f, b, c, h, e) {
		var g, k;
		a.width / 2;
		switch (f.beginPath(), null != a.gcColor && (e = K), f.fillStyle = e, f.strokeStyle = e, h) {
		case 0:
		...
		f.lineTo(g, k);
		f.closePath();
		null != a.foreground ? T(f) : (f.fill(), f.stroke())
	},
	N = function(f, b, c) {
		switch (grd = "", a.gradientWay) {
		case "backslash":
		...
		return 0 != a.gradientWay && (grd.addColorStop(0, b), grd.addColorStop(1, a.gcColor)),
		grd
	},
	S = function(f, b, c) {
	...
	U = function(a, b, c, d, e, g, k) {
		...
		$(D).bind({
			mousedown: function(c) {
				...
				g > k.left * h && g < (k.left + k.width) * h && c > k.top * h && c < (k.top + k.height) * h ? (w = !0, d = k.left - g, b = k.top - c) : w = !1;
				y = !0
			},
			mouseup: function(a) {
				var b = $(this).position();
			...
			mousemove: function(c) {
				...
				w ? (k.left = d + g, k.top = b + c, u.drawImage()) : y && u.drawImage()
			},
