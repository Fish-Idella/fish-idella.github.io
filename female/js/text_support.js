...
translations = {
	'#main-title' : { 'english' : ['身形可视化', '女性', '男性'], 'german' : ['K\366rper Visualizer', '女性', 'M\344nnliche'] },
	'#switch_gender_link' : { 'english' : ['switch to female', 'switch to male'], 'german' : ['Umschalten auf Weiblich', 'Umschalten auf M\344nnlich'] },
	'#height-slider-label' : { 'english' : ['Height'], 'german' : ['身高'] },
	'#age-slider-label' : { 'english' : ['Age'], 'german' : ['年龄'] },
	'#weight-slider-label' : { 'english' : ['Weight'], 'german' : ['体重'] },
	'#chest-slider-label' : { 'english' : ['Chest'], 'german' : ['胸围'] },
	'#waist-slider-label' : { 'english' : ['Waist'], 'german' : ['腰围'] },
	'#hips-slider-label' : { 'english' : ['Hips'], 'german' : ['臀围'] },
	'#inseam-slider-label' : { 'english' : ['Inseam'], 'german' : ['腿长'] },
	'.slider-units' : { 'english' : ['inches', 'pounds', 'years', 'centimeters', 'kilograms', 'hours/week'],
	                     'german' : ['厘米', 'Pfund', '年', '厘米', '公斤', '小时/周'] },
