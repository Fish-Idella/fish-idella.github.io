new Promise((resolve, reject) => {
    ...
    window.FillView = FillView
        ...
        .set("input", function () {
            let child, label = FillView.get("switch").cloneNode();
        ...
        .set("object-list", function () {
            let div = FillView.parseHtml('<div class=object-list><div class=subtitle-bar><span class=text></span> <input class=add type=button value=添加></div><span class=long_text></span><ul class=list></ul></div>');
            return div;
        }, {
            length: 1,
            ...
            0: function (target, value, key, i) {
                ...
                let self = this;
                for (let id in obj) {
                    let li = FillView.get("list-item").cloneNode();
                    li.title = id;
        ...
        .set("array-list", function () {
            const div = FillView.get("object-list").cloneNode();
            ...
            const vm_a = PuSet.View({
                ...
                template: FillView.get("list-item").cloneNode(),
            ...
            const view = FillView.get("object-list");
        ...
        .set("radio", function () {
            ...
            return FillView.parseHtml(radio);
        })

        .set("radio-list", function () {
            ...
            PuSet.each(arr, function (value1, i) {
                let label = FillView.get("radio").cloneNode();
        ...
        .set("image-select", function () {
            ...
            let div = FillView.parseHtml(`<div class="image-select" data-psid="boolean_file_wallpaper">
    ...
    <div class="flex-horizontal image-select-box">
        <div class="bgPreviewBox">
            <div class="bgPreBoxInner unset" id="bgPreBoxInnerCustom">
    ...
    function fillContent(subTarget, subValue, key, i) {
        ...
        PuSet.View({
            ...
            template: function (index, type) {
                return FillView.get(type).cloneNode();
            },
            layout: function (target, value, key, i) {
                ...
                FillView.get(value.type).fn(0, target, value, key, i);
            }
        });
    }
    ...
    function createView() {
        PuSet.View({
            ...
            layout: function (target, value, key, index) {
                ...
                // 右侧列表 -----------------------------------------------------------------------------
                let mainTarget = FillView.get("main-title").cloneNode();
    ...
    document.getElementById("add-link-button").addEventListener("click", function () {
        FillView.get("object-list").fn("show-alert", "map_all_links");
    });
